...
public class Runner {
    public static void main(String[] args) {
        ...
        if (insert[0].equals("lvcreate")) {
            if (manager.lvCreate(insert[1], Integer.parseInt(insert[2]), insert[3]) == false)
        ...
        if (insert[0].equals("lvlist")) {
            ...
            System.out.println("If you want to end the processes, type in end");
            input = scan.nextLine();
            insert = input.split(" ");
    }
        System.out.println("Proccesses end.");
        scan.close();
